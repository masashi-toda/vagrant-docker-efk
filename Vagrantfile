...
#  config.vm.synced_folder ".", "/vagrant", :nfs => true
  ...
  config.vm.network "forwarded_port", id: "nginx",          host: 80,    guest: 80,    auto_correct: true
  config.vm.network "forwarded_port", id: "fluentd",        host: 24224, guest: 24224, auto_correct: true
